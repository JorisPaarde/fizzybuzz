...
> **Productdocumentatie:** [`FUNCTIONALITEIT.md`](FUNCTIONALITEIT.md) — lees dit eerst (inhoudsopgave bovenaan).  
> **Homepage:** [`docs/HOMEPAGE.md`](docs/HOMEPAGE.md) — structuur & Sutherland-uitgangspunten  
